    ...
    <div className={`menu ${isOpen ? 'active' : ''}`}>
      <nav className="navbar">
        <ul>
          ...
          <li><NavLink to='fresh'className={({isActive}) => isActive ? 'active-link' : ''}>Fresh</NavLink></li>
          <li><NavLink to='about'className={({isActive}) => isActive ? 'active-link' : ''}>About</NavLink></li>
          <li><NavLink to='contact' /*onClick={handleScroll}*/ className={({isActive}) => isActive ? 'active-link' : ''}>Contact</NavLink></li>
        </ul>
      </nav>
